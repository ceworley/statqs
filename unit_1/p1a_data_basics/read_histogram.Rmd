...
* Evaluate boundary $b$ such that $\#[\mathbf{x}<b] = `r n5`$.
* Evaluate boundary $b$ such that $\#[\mathbf{x}>b] = `r n6`$.
* Evaluate radius $r$ such that $\#[|\mathbf{x}-`r c7`|<r] = `r n7`$.
* Evaluate radius $r$ such that $\#[|\mathbf{x}-`r c8`|>r] = `r n8`$.
