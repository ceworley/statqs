...
We can approximate a 95% confidence interval (where the 95% refers to how frequently the true population mean lands inside these intervals) by using $\bar{x}\pm \frac{2 s}{\sqrt{n}}$.
...
If we know $s$ will be approximately `r s`, and we want the margin of error to be approximately `r me`, then how large does the sample size need to be?
