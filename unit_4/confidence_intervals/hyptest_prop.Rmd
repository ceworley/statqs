...
The scientist wonders if this survival rate is significantly different from $p_0$. To do this, the scientist will determine the $p$-value. The $p$-value represents the probability of getting a sample proportion as far (or farther) from $p_0$ due to chance alone.
