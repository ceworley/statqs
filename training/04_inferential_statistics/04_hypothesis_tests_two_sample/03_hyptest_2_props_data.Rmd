...
Just for completeness, you would also get credit for using [Fisher's exact test](https://en.wikipedia.org/wiki/Fisher%27s_exact_test){target="blank"}.
...
[video](https://vimeo.com/531954640){target="_blank"}
