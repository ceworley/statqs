...
When you have binary data, the sample proportion is the number of successes (1s) divided by the sample size.
...
The sample mean is found by summing the measurements and dividing the sum by the sample size.
$$\bar{x} = \frac{\sum x}{n} $$
