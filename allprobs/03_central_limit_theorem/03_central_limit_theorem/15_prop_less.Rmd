...
In some game, each trial has a $p = `r p`$ probability of success. A player will attempt `r n` trials. What is the probability that the proportion of successes is less than `r phat`?


Solution
========

[video](https://vimeo.com/531942937){target="_blank"}
